...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::composer::run_composer,
            commands::database::list_db_users,
            commands::database::create_db_user,
            commands::database::drop_db_user,
            commands::database::list_databases,
            commands::database::create_database,
            commands::database::drop_database,
            commands::database::grant_db_access,
            commands::database::revoke_db_access,
            commands::database::list_user_grants,
